    ...
    **"mystage"** can recognized all following folders:
    ...
    def __init__(self, job_info, report_root):
        ...
        .. py:attribute:: result_root
            ...
            :class:`~pathlib.Path` object to stage result root.
            Auto-generated by finding the matched foldername
            based on :attr:`result_foldername`, and the prefix numbering will
            be ignored.
